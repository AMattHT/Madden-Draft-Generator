...
const SLOTS: SlotDef[] = [
  ...
  { slot: 'armLeft', label: 'Left arm sleeve', category: 'armSleeves', slotTypes: ['LeftArmWear'], none: { value: 'ArmSleeve_None', label: 'No sleeve' } },
  { slot: 'armRight', label: 'Right arm sleeve', category: 'armSleeves', slotTypes: ['RightArmWear'], none: { value: 'ArmSleeve_None', label: 'No sleeve' } },
  { slot: 'elbowLeft', label: 'Left elbow', category: 'elbowGear', slotTypes: ['LeftElbowWear'], none: { value: 'ElbowGear_None', label: 'None' } },
